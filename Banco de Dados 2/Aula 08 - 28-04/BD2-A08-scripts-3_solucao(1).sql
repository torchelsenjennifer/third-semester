...
*/
SELECT filme.tituloPortugues, -- seleciona o campo tituloPortugues da tabala filme
       tipoPagto.nome AS 'Tipo Pagto.', --seleciona o campo nome da tabela tipoPagto
       SUM(venda.valorIngresso) AS 'Somatório (R$)' -- seleciona o campo valor ingresso na tabela venda e soma
FROM filme -- na tabela filme

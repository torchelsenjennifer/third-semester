...
mysqlslap --user=root --password --host=localhost  --concurrency=90 --iterations=10 --create-schema=aula11 --query="SELECT MAX(id) FROM usuario;"

mysqlslap --user=root --password --concurrency=90 --iterations=20 --number-int-cols=2 --number-char-cols=3 --auto-generate-sql
